...
class MemoController: NSViewController {
    ...
    override func viewDidLoad() {
        ...
        var memo_content_p = Param(st_ :memo_content_st,x_:50,y_:50,width_:300,height_:200,fontSize_:12)
        ...
        var return_btn_p = Param(st_ :"保存",x_:200,y_:270,width_:75,height_:20,fontSize_:13)
    ...
    @objc func store_click(_ sender: CustomNSButton){
        ...
        UserDefaults.standard.set(memo_content.stringValue, forKey: "memo_content_st")
